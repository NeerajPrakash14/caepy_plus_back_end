...
Configures Alembic to work with SQLAlchemy and our application settings.
"""
...
from src.app.models import Doctor  # noqa: F401 - Import to register models
...
# Override sqlalchemy.url from our settings - convert async to sync driver
